...
namespace News.Controllers
{
    public class NewsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            News.Models.News news = db.NewsArticle.Find(id);
            if (news == null)
            {
                return HttpNotFound();
            }
        ...
        {
            News.Models.LoginData logindata = new News.Models.LoginData(HttpContext);
        ...
        [SessionAuthorize]
        public ActionResult Create([Bind(Include = "NewsID,Text,UserID,timestamp,deleted")] News.Models.News news)
        {
            News.Models.LoginData logindata = new News.Models.LoginData(HttpContext);
            if (!logindata.usertype().Equals("Publisher")) { return RedirectToAction("Index", "News", null); }
        ...
        [ValidateAntiForgeryToken]
        [SessionAuthorize]
        public ActionResult Edit([Bind(Include = "NewsID,Text,UserID,timestamp,deleted")] News.Models.News news)
        {
            News.Models.LoginData logindata = new News.Models.LoginData(HttpContext);
            if (!logindata.usertype().Equals("Publisher")) { return RedirectToAction("Index", "News", null); }
